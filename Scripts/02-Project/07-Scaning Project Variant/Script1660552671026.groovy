...
for (int baris = 1; baris <= 1; baris++) {
	...
	WebUI.delay(2)
	WebUI.click(findTestObject('Object Repository/AppSec/02-Summary Project/02-Scan Project/Button OK'))
	WebUI.delay(3)
	WebUI.verifyTextPresent('SCAN FAILED', false, FailureHandling.OPTIONAL)
