...
//LOGIN
WebUI.setText(findTestObject('Object Repository/Login/Input Username'), GlobalVariable.admin[7])
WebUI.delay(1)
...
WebUI.setText(findTestObject('Object Repository/AppSec/02-Summary Project/02-Detail Project-Create Project/Input Project Name'), 'Project-03')
WebUI.delay(1)
WebUI.setText(findTestObject('Object Repository/AppSec/02-Summary Project/02-Detail Project-Create Project/Input Description'), 'project-03')
WebUI.delay(1)
