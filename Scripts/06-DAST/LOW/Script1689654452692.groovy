...
WebUI.delay(1)
WebUI.enhancedClick(findTestObject('Object Repository/07-DAST/Issue-Context/Filtering/RISK-LOW'))
WebUI.delay(1)
WebUI.takeScreenshot()

TestObject LOW = new TestObject().addProperty('xpath', ConditionType.EQUALS, "/html/body/div[1]/div[6]/div/div/div/div[2]/div[2]/div/div[3]/div/div/div[2]/span")
String countLO = WebUI.getText(LOW)
int countLOW = Integer.valueOf(countLO)
