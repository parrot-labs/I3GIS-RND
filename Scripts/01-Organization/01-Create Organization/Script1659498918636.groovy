...
for (int baris = 1; baris <= input.getRowNumbers(); baris++) {
	...
	if (WebUI.verifyTextPresent(input.getValue('organization', baris), false, FailureHandling.OPTIONAL) == true) {
		...
		WebUI.setText(findTestObject('Object Repository/01-Organization/01-Create New Organization/Input Organization'), input.getValue('organization', baris))
		WebUI.delay(1)
