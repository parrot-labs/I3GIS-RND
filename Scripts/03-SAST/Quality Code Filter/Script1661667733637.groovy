...
WebUI.delay(1)
WebUI.waitForElementClickable(findTestObject('Object Repository/03-SAST/03-Quality Code/Quality Code Filter/Input new Filter'), 0, FailureHandling.OPTIONAL)
WebUI.delay(1)
