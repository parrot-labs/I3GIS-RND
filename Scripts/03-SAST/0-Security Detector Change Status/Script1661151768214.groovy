...
while (status == true) {
	...
	TestObject data_text = findTestObject('Object Repository/03-SAST/percentage')
		
	String text = WebUI.getText(data_text)
	println(text)
	String hasil = text.substring(0, text.length()-1)
	println(hasil)
	status = WebUI.verifyNotEqual(hasil, '100.0', FailureHandling.OPTIONAL)
