...
WebUI.delay(1)
WebUI.enhancedClick(findTestObject('Object Repository/07-DAST/Issue-Context/Filtering/RISK-INFORMATION'))
WebUI.delay(1)
WebUI.takeScreenshot()

TestObject INFORMATION = new TestObject().addProperty('xpath', ConditionType.EQUALS, "/html/body/div[1]/div[6]/div/div/div/div[2]/div[2]/div/div[4]/div/div/div[2]/span")
String countIN = WebUI.getText(INFORMATION)
int countINFORMA = Integer.valueOf(countIN)
