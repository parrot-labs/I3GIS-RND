...
WebUI.delay(1)
WebUI.enhancedClick(findTestObject('Object Repository/07-DAST/Issue-Context/Filtering/RISK-HIGH'))
WebUI.delay(1)
WebUI.takeScreenshot()

TestObject HIGH = new TestObject().addProperty('xpath', ConditionType.EQUALS, "/html/body/div[1]/div[6]/div/div/div/div[2]/div[2]/div/div[1]/div/div/div[2]/span")
String countHI = WebUI.getText(HIGH)
int countHIGH = Integer.valueOf(countHI)
