...
for (int baris = 1; baris <= 1; baris++) {
	...
	WebUI.delay(1)
	WebUI.setText(findTestObject('Object Repository/Login/Input Password'), input.getValue('password', baris))
	WebUI.delay(1)
	...
	WebUI.waitForElementPresent(findTestObject('Object Repository/Button-Lobby'), 0, FailureHandling.OPTIONAL)
	WebUI.verifyElementClickable(findTestObject('Object Repository/Button-Lobby'), FailureHandling.OPTIONAL)
	WebUI.takeScreenshot()
}