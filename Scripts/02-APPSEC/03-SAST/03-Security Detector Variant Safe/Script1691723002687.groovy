...
for (int baris = 1; baris <= 1; baris++) {
	...
	WebUI.delay(1)
	WebUI.click(findTestObject('Object Repository/03-SAST/03-Security Detector/Change Status/Div Safe'))
	WebUI.delay(1)
...
WebUI.delay(1)
WebUI.click(findTestObject('Object Repository/03-SAST/03-Security Detector/Filter/Div Reviewed Safe'))
WebUI.delay(2)
