...
for (int baris = 1; baris <= input.getRowNumbers(); baris++) {
	...
	WebUI.delay(1)
	WebUI.setText(findTestObject('Object Repository/AppSec/02-Summary Project/02-Detail Project-Existing Project/Input Search Project'), input.getValue('select-project', baris))
	WebUI.delay(2)
