...
WebUI.delay(1)
WebUI.verifyTextPresent('Scan Validation', false, FailureHandling.OPTIONAL)
WebUI.delay(1)
...
for (int baris = 1; baris <= input.getRowNumbers(); baris++) {
	...
	WebUI.delay(1)
	WebUI.verifyTextPresent('Create new profile success', false, FailureHandling.OPTIONAL)
	WebUI.takeScreenshot()
	WebUI.click(findTestObject('Object Repository/07-Scan Validation/Ceklis-Project 1'))
	WebUI.delay(1)
	WebUI.verifyTextPresent('You enable project to use this profile', false, FailureHandling.OPTIONAL)
	WebUI.takeScreenshot()
	WebUI.click(findTestObject('Object Repository/07-Scan Validation/Ceklis-Project 1'))
	WebUI.delay(1)
	WebUI.verifyTextPresent('You disable project to use this profile', false, FailureHandling.OPTIONAL)
	WebUI.takeScreenshot()
	...
	WebUI.delay(4)
	WebUI.verifyTextPresent('Set priority to all project success', false, FailureHandling.OPTIONAL)
	WebUI.takeScreenshot()
	...
	WebUI.delay(1)
	WebUI.verifyTextPresent('Delete profile success', false, FailureHandling.OPTIONAL)
	WebUI.takeScreenshot()
}