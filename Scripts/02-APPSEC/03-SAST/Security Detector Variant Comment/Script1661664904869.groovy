...
for (int baris = 1; baris <= input.getRowNumbers(); baris++) {
	...
	WebUI.setText(findTestObject('Object Repository/03-SAST/03-Security Detector/Comment/Input Comment'), input.getValue('Comment', baris))
	WebUI.delay(1)
	...
	WebUI.click(findTestObject('Object Repository/03-SAST/03-Security Detector/Comment/Add Comment'))
	WebUI.delay(3)
	WebUI.verifyTextPresent('Success to create comment', false, FailureHandling.OPTIONAL)
	WebUI.verifyTextPresent(input.getValue('Comment', baris), false, FailureHandling.OPTIONAL)
	WebUI.takeScreenshot()
	...
	WebUI.delay(1) 
	WebUI.setText(findTestObject('Object Repository/03-SAST/03-Security Detector/Comment/Re edit Comment'), input.getValue('Comment1', baris))
	WebUI.delay(1)
